...
class SongGenerator {
	...
	createRythmFromMelody(pattern) {
		...
		let drums = [ 14, 15 ]; //Bass drum, Hihat
...
*/
	...
	developIdea(pattern){
		...
		while(1) {
			...
			//TODO: randomly change some stuff based on some factors - positionInSong, tension
			//Mutations:
			//question / answer,
			//peaks / troughs;
			//tension + resolving
			...
			//TODO: ...then qualiy control with AI / tensorflow..
			if(1 > 0.8) {
				break;
			}
		}
